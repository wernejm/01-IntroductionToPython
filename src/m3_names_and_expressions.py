...
#   Run your code (fix errors as needed), then change the above _TODO_ to DONE.
###############################################################################
print('math.sqrt(2)', 'equals the square root of 2')
print(math.sqrt(2))
print('2 ** 0.5', 'also equals the square root of 2')
print(2 ** 0.5)
...
print("'hello' is", type('hello'))
print("'a b c' is", type('a b c'))
print('3 + 3 is', type(3 + 3))
print('"3" + "3"', "is", type("3" + "3"))
print("2 ** 100", "is", type(2 ** 100))
print("2.0 ** 100", "is", type(2.0 ** 100))
print("math.sin(8)", "is", type(math.sin(8)))
print("math.sin", "is", type(math.sin))
